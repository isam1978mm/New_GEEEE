...
PHASE5E_REFERENCE_CASES: tuple[Phase5Case, ...] = (
    ...
    Phase5Case("stacks", "hypercube tif reference", "raster_reference", "NPY_STACKS/FINAL_TESLA_V7_2_HYPERCUBE.tif", "NPY_STACKS/FINAL_TESLA_V7_2_HYPERCUBE.tif", tolerance=0.0),
    Phase5Case("stacks", "hypercube npy reference", "npy_reference", "NPY_STACKS/FINAL_TESLA_V7_2_HYPERCUBE.npy", "NPY_STACKS/FINAL_TESLA_V7_2_HYPERCUBE.npy", tolerance=0.0),
    Phase5Case(
        "stacks",
        "patched 14b tif reference",
        "raster_reference",
    ...
    Phase5Case(
        ...
        expected="xfail",
        xfail_reason="known inherited SAR dB residual",
    ),
