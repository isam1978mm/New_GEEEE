          ...
          <div className="px-4 py-3 flex flex-col gap-3">
            ...
            >
              <div style={{ fontSize: "11px", color: "var(--gs-slate)", lineHeight: "1.5" }}>
                The browser does not create operator identity, role, or run-authorization headers. A trusted upstream layer must provide them in network deployments. Local development remains loopback-only. Private overlay must show coordinate-free summaries only. Private geometry is never returned in the local-depth response.
              </div>
            </div>
          </div>
        </section>
