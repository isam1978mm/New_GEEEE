#!/usr/bin/env python3
"""Recover primary Aitik cover-trial construction and monitoring records.
...
OUT = Path("artifacts/aitik_cover_trial_records")
OUT.mkdir(parents=True, exist_ok=True)

DOCS = {
    "2015_construction": [
        "https://www.imwa.info/docs/imwa_2015/IMWA2015_McKeown_153.pdf",
        "https://www.imwa.info/docs/imwa_2015/IMWA2015_McKeown153.pdf",
        "https://www.imwa.info/docs/imwa_2015/IMWA2015_McKeown.pdf",
    ],
    "2025_climate_monitoring": [
        "https://papers.acg.uwa.edu.au/d/2515_93_Mckeown/93_Mckeown.pdf",
    ],
}
...
keyword_re = re.compile(
    r"as[- ]built|constructed|cover system field trial|protective layer|growth medium|"
    r"thickness|lift|plateau|50 m|dimension|survey|coordinate|northing|easting|"
    r"accuracy|tolerance|density|nuclear|monitoring|vegetative|vegetation|"
    r"repair|disturb|erosion|settlement|subsidence|Figure|Table",
    re.IGNORECASE,
)
...
for name, urls in DOCS.items():
    ...
    for item in page_hits:
        ...
        score = len(item["hits"])
        for term in (
            "as-built", "thickness", "protective layer", "50 m", "survey",
            "coordinate", "accuracy", "tolerance", "density", "vegetation",
            "repair", "erosion", "settlement",
        ):
            if term in joined:
                score += 18
