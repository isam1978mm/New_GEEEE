"""Run Campaign 014 with a hard watchdog around each live ATL08 tile query.
...
ATL08 query hook with a subprocess-backed wall-clock watchdog. Completed tile
caches remain resumable. Scientific thresholds, source/event gates, finalizers,
