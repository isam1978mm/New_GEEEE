...
def main():
 ...
 tab1=ps(s,{"tab":1,"destination":4,"coordinates":[{"c":0,"a":f"{LAT:.4f}","o":f"{LON:.4f}"}],"format":"dd","dStart":"01/01/2000","dEnd":"08/31/2004","searchType":"Std","includeUnknownCC":"1","maxCC":100,"minCC":0,"months":list(range(1,13)),"pType":"point"})
 ...
 rr=rows(sr.text,cid)
 # only follow explicit page selectors, at most 10 pages
